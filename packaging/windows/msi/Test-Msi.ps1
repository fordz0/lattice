...
$invokeFlags = [System.Reflection.BindingFlags]::InvokeMethod
$invokeArgs = New-Object object[] 2
$invokeArgs[0] = $resolvedPath
$invokeArgs[1] = 0
$database = $installer.GetType().InvokeMember('OpenDatabase', $invokeFlags, $null, $installer, $invokeArgs)
