...
<body data-theme="dark">
        ...
        <div class="identity-shell">
          ...
          <div id="identity-dropdown" class="identity-dropdown hidden">
            ...
            <div class="inline-actions">
              ...
              <button id="identity-transfer" class="btn-ghost" type="button">Transfer Handle</button>
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="onboarding-modal" class="modal-backdrop hidden">
    <div class="modal-card">
      <div>
        <h2 class="title">Claim your handle</h2>
        <div class="muted">Your handle is tied to your node key and claimed on the Lattice network. Once claimed, only you can use it.</div>
      </div>
  ...
  <script>
    ...
    el("identity-transfer").addEventListener("click", () => {
      el("onboarding-handle").value = "";
      el("onboarding-error").textContent = "claiming a new handle will release your old one";
      el("onboarding-modal").classList.remove("hidden");
    });
